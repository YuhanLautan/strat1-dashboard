...
function renderGateHistory(days, rawHit, flag, rangePct, gateMap, newTrades, cumMap) {{
  ...
  if (currentGateOpen) {{
    ...
    const windowPriceLabel = `${{fmtUsd(windowLow)}} – ${{fmtUsd(windowHigh)}}`;
    ...
    const rangePriceLabel = currentRangePct === null ? "" : windowPriceLabel;
    ...
    currentEl.innerHTML = `<p class="manual-note">Gate is currently <b class="val down">CLOSED</b> as of ${{todayEffective}} (UTC).
      ...
      <div class="gate-progress">
        ...
        <div class="gate-progress-row gate-progress-subrow">
          ...
          <span class="gate-progress-subval">window: ${{windowPriceLabel}} · needs to stay under ${{fmtUsd(qualifyingCeiling)}} (${{CFG.CAUSAL_DETECTOR_THRESHOLD_PCT}}% above today's low) once the current high ages out</span>
        </div>
        <div class="gate-progress-row">
        ...
        <div class="gate-progress-row gate-progress-subrow">
          <span class="gate-progress-label"></span>
          <span class="gate-progress-subval">window: ${{rangePriceLabel}}</span>
        </div>
        <div class="gate-progress-row">
